...
public class principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Exemplo de Login e Cadastro Simples");
        ...
        cadastre_se.setText("Cadastrar-se");
    ...
    private void logarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logarActionPerformed
        ...
        user.setLogin(jlogin.getText());
        user.setSenha(jsenha.getText());
        
        int i = log.validar(user.getLogin(),user.getSenha());
            if ( i > 0) {
               JOptionPane.showMessageDialog(rootPane, "Sucesso!!");
                log.desconectar();
            }else{
                JOptionPane.showMessageDialog(rootPane, "Login errado,tente novamente!");
            }
